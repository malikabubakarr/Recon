...
export default function Categories() {
  const pageTitle = "Shop by Category | RECON";
  const pageDescription = "Explore RECON products by category, including hair colors, oils, waxes, lotions, and more.";
  const canonicalUrl = "https://maksoninternational.com/categories";
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="keywords" content="RECON, Makson International, Hair Colors, Wax, Hair Oil, Lotions, Tissues, Categories" />
        ...
        {/* Optional OG image: first category image */}
        <meta property="og:image" content={categories[0].img} />
